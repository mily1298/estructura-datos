...
public class VerticeSVG{
	...
	*/
	public VerticeSVG(int elemento, int xPadre, int yPadre, boolean esIzquierdo, int indice, int diferencia){
		this.xPadre = xPadre;
		this.yPadre = yPadre;
	...
	*/
	public VerticeSVG(int elemento, int x, int y){
		this.xPadre = x;
		this.yPadre = y;
		this.coorX = x;
		this.coorY = y;
	...
	*/
	public VerticeSVG(int elemento, int x, int y, Color color){
		this.xPadre = x;
		this.yPadre = y;
		this.coorX = x;
		this.coorY = y;
	...
	*/
	public VerticeSVG(int elemento, int x, int y, int altura, int balance){
		this.xPadre = x;
		this.yPadre = y;
		this.coorX = x;
		this.coorY = y;
	...
	*@param diferencia int  
	*/
	public VerticeSVG(int elemento, int xPadre, int yPadre, Color color,boolean esIzquierdo, int indice, int diferencia){
		this.xPadre = xPadre;
		this.yPadre = yPadre;
		this.elemento= elemento;
		this.color = color;
	...
	*@param diferencia int  
	*/
	public VerticeSVG(int elemento, int xPadre, int yPadre, int altura,int balance,boolean esIzquierdo, int indice, int diferencia){
		this.xPadre = xPadre;
		this.yPadre = yPadre;
		this.elemento= elemento;
		this.arbol = "arbolAVL";
